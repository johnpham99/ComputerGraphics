function setup() {
  createCanvas(700, 700); //set size of screen
}
...
function draw() {
  ...
  function makeCircles(mainCircle) {
      let newCircles = [];
      for (let i = 0; i < 6; i++) {
        newCircles[i] = {object: circle(mainCircle.x + mainCircle.d * cos(i * angle + mainCircle.r), mainCircle.y + mainCircle.d * sin(i * angle + mainCircle.r), mainCircle.d * k), 
